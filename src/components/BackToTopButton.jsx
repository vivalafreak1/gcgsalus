  ...
  return (
    <>
      {isVisible && (
        <button
          onClick={scrollToTop}
          className="fixed p-3 text-blue-500 transition duration-300 ease-in-out transform bg-white border-2 border-blue-500 rounded-full shadow-lg bottom-4 right-4 hover:bg-blue-500 hover:text-white hover:scale-105"
